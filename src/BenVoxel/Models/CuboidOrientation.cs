...
public sealed class CuboidOrientation : ITurnable
{
	...
	public ITurnable Turn(params Turn[] turns)
	{
		...
		foreach (Turn turn in turns)
			...
			{
				BenVoxel.Structs.Turn.ClockX => Values[Clock[0][cuboidOrientation.Value]],
				BenVoxel.Structs.Turn.ClockY => Values[Clock[1][cuboidOrientation.Value]],
				BenVoxel.Structs.Turn.ClockZ => Values[Clock[2][cuboidOrientation.Value]],
				BenVoxel.Structs.Turn.CounterX => Values[Counter[0][cuboidOrientation.Value]],
				BenVoxel.Structs.Turn.CounterY => Values[Counter[1][cuboidOrientation.Value]],
				BenVoxel.Structs.Turn.CounterZ => Values[Counter[2][cuboidOrientation.Value]],
				_ => SOUTH0,
			};
