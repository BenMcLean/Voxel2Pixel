...
namespace Voxel2Pixel.Model
{
	...
	public class TurnModel : IModel, ITurnable
	{
		...
		public int Size(int axis) => ModelSize(CubeRotation.Rotation[axis]);
		/// <summary>
		...
		public int Start(int axis) =>
			CubeRotation.Rotation[axis] is int rot && rot < 0 ?
		...
		#region IModel
		public int SizeX => Size(0);
		public int SizeY => Size(1);
		public int SizeZ => Size(2);
