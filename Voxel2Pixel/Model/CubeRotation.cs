...
namespace Voxel2Pixel.Model
{
	...
	public sealed class CubeRotation : ITurnable
	{
		...
		public static readonly CubeRotation
			...
			WEST0 = new CubeRotation(4, "WEST0", -2, -1, zPlus),
			WEST1 = new CubeRotation(5, "WEST1", -2, 2, 0),
			WEST2 = new CubeRotation(6, "WEST2", -2, 0, zMinus),
			WEST3 = new CubeRotation(7, "WEST3", -2, -3, -1),
			NORTH0 = new CubeRotation(8, "NORTH0", 0, yMinus, zPlus),
			NORTH1 = new CubeRotation(9, "NORTH1", 0, yMinus, 1),
			NORTH2 = new CubeRotation(10, "NORTH2", 0, yMinus, zMinus),
			NORTH3 = new CubeRotation(11, "NORTH3", 0, yMinus, -2),
			EAST0 = new CubeRotation(12, "EAST0", -2, 0, zPlus),
			EAST1 = new CubeRotation(13, "EAST1", 1, 2, -1),
			EAST2 = new CubeRotation(14, "EAST2", 1, -1, zMinus),
