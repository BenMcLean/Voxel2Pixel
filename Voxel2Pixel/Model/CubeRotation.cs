...
namespace Voxel2Pixel.Model
{
	...
	public sealed class CubeRotation : ITurnable
	{
		...
		public static readonly CubeRotation
			...
			WEST1 = new CubeRotation(5, "WEST1", zMinus, xMinus, yPlus),//24
			WEST2 = new CubeRotation(6, "WEST2", yMinus, xMinus, zMinus),//15
			WEST3 = new CubeRotation(7, "WEST3", zPlus, xMinus, yMinus),//20
			NORTH0 = new CubeRotation(8, "NORTH0", xMinus, yMinus, zPlus),//9
			NORTH1 = new CubeRotation(9, "NORTH1", zMinus, yMinus, xMinus),//12
			NORTH2 = new CubeRotation(10, "NORTH2", xPlus, yMinus, zMinus),//11
			NORTH3 = new CubeRotation(11, "NORTH3", zPlus, yMinus, xPlus),//10
			EAST0 = new CubeRotation(12, "EAST0", yMinus, xPlus, zPlus),//13
			EAST1 = new CubeRotation(13, "EAST1", zMinus, xPlus, yMinus),//18
			EAST2 = new CubeRotation(14, "EAST2", yPlus, xPlus, zMinus),//7
			EAST3 = new CubeRotation(15, "EAST3", zPlus, xPlus, yPlus),//22
			UP0 = new CubeRotation(16, "UP0", xMinus, zMinus, yMinus),//19
			UP1 = new CubeRotation(17, "UP1", yPlus, zMinus, xMinus),//8
			UP2 = new CubeRotation(18, "UP2", xPlus, zMinus, yPlus),//21
			UP3 = new CubeRotation(19, "UP3", yMinus, zMinus, xPlus),//14
			DOWN0 = new CubeRotation(20, "DOWN0", xMinus, zPlus, yPlus),//23
			DOWN1 = new CubeRotation(21, "DOWN1", yMinus, zPlus, xMinus),//16
			DOWN2 = new CubeRotation(22, "DOWN2", xPlus, zPlus, yMinus),//17
			DOWN3 = new CubeRotation(23, "DOWN3", yPlus, zPlus, xPlus);//6
