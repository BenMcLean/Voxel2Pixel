...
namespace Voxel2Pixel.Model
{
	...
	public sealed class CubeRotation : ITurnable
	{
		...
		public static readonly CubeRotation
			...
			WEST1 = new CubeRotation(5, "WEST1", yPlus, 2, 0),
			WEST2 = new CubeRotation(6, "WEST2", yPlus, 0, zMinus),
			WEST3 = new CubeRotation(7, "WEST3", yPlus, -3, -1),
			...
			EAST1 = new CubeRotation(13, "EAST1", yMinus, 2, -1),
			EAST2 = new CubeRotation(14, "EAST2", yMinus, -1, zMinus),
			EAST3 = new CubeRotation(15, "EAST3", yMinus, -3, 0),
